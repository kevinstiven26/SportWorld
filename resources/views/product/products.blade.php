                ...
                @foreach ($products as $product )
                    <div class="col-lg-4 col-md-6">
                        ...
                        <div class="text">
                            ...
                            <p class="buttons"><a href="detail.html" class="btn btn-outline-secondary">Ver Detalle</a><a href="basket.html" class="btn btn-primary"><i class="fa fa-shopping-cart"></i>Añadir al Carrito</a></p>
                        </div>
                        <!-- /.text-->
                        </div>
                        <!-- /.product            -->
